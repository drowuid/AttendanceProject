...
@section('content')
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div class="container mx-auto flex flex-col lg:flex-row gap-8">
            ...
            <!-- Sidebar -->
            <aside class="w-full lg:w-56 bg-white dark:bg-gray-800 rounded-xl shadow p-5 mb-6 lg:mb-0 lg:sticky top-8 h-fit">
                <div class="mb-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                    Quick Actions
                </div>
                <a href="{{ route('admin.absences.index') }}"
                    class="block px-4 py-2 bg-indigo-500 text-white rounded hover:bg-indigo-600 text-xs font-medium text-center mb-2">
                    Manage Absences
                </a>
            ...
            new Chart(reasonCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: [
                            '#4F46E5', '#10B981', '#F59E0B', '#EF4444', '#6366F1', '#EC4899', '#22D3EE', '#F97316'
                        ],
                        borderWidth: 1
                    }]
                },
