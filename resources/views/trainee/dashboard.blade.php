    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div class="container mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 mb-6 flex justify-between items-center">
                ...
                <!-- Profile & Absences Buttons -->
                <div class="flex space-x-3">
                    <a href="{{ route('trainee.profile') }}"
                        class="inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded-lg shadow hover:bg-indigo-700 transition-colors duration-150 text-sm font-medium">
                        View Profile
                    </a>
                    <a href="{{ route('trainee.absences.index') }}"
                            ...
                            <tbody>
                                @foreach ($modules as $module)
                                    <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="py-2">
                                            {{ $module->start_date ? \Carbon\Carbon::parse($module->start_date)->format('d/m/Y') : 'N/A' }}
                                        </td>
                                        <td class="py-2">
                                            {{ $module->end_date ? \Carbon\Carbon::parse($module->end_date)->format('d/m/Y') : 'N/A' }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
